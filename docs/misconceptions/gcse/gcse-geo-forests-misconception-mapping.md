...
`docs/misconceptions/gcse/gcse-geo-hazards-misconception-mapping.md`. Same problem, same method:
...
`docs/misconceptions/gcse/gcse-geo-energy-misconception-mapping.md`, which carries the current
