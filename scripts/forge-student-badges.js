(function() {
  ...
  fetch(url + '/rest/v1/assignments?select=id,archived,due_date&class_id=eq.' + saved.classId, {headers:{apikey:key,Authorization:'Bearer '+key}})
