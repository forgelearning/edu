...
belongs in CSS and is checked by `scripts/check-ui-system.js`.
...
```sh
node scripts/check-ui-system.js
node scripts/check-content-readiness.js
node scripts/check-question-bank.js
